  ...
  <div class="main">
    <div class="info">
      <a-tooltip placement="bottom" >
        <template slot="title">
            <span>本工具用于批量删减文件名中的特定字符，例如：优秀作文(小明).txt -> 优秀作文.txt</span>
        </template>
  ...
  methods: {
    ...
    preview(){
      ...
      for (let f of this.fileList) {
        ...
        let newname = oldname.replace(this.deleteStr, '')
